...
COPY Cargo.toml .
COPY Cargo.lock .
COPY attestation_server/api/Cargo.toml ./attestation_server/api/Cargo.toml
COPY attestation_server/policy/Cargo.toml ./attestation_server/policy/Cargo.toml
COPY attestation_server/ref_value/Cargo.toml ./attestation_server/ref_value/Cargo.toml
COPY attestation_server/endorserment/Cargo.toml ./attestation_server/endorserment/Cargo.toml
COPY attestation_server/nonce/Cargo.toml ./attestation_server/nonce/Cargo.toml
COPY attestation_server/token/Cargo.toml ./attestation_server/token/Cargo.toml
COPY attestation_server/policy_engine/Cargo.toml ./attestation_server/policy_engine/Cargo.toml
COPY attestation_server/key/Cargo.toml ./attestation_server/key/Cargo.toml
COPY attestation_server/attestation/Cargo.toml ./attestation_server/attestation/Cargo.toml
COPY attestation_server/resource_provider/Cargo.toml ./attestation_server/resource_provider/Cargo.toml
COPY attestation_server/server_config/Cargo.toml ./attestation_server/server_config/Cargo.toml
